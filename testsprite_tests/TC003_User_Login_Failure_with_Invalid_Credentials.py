...
async def run_test():
    ...
    try:
        ...
        # -> Input invalid email and password, then click the login button.
        frame = context.pages[-1]
        # Input invalid email
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Invalid email or password. Please try again.').first).to_be_visible(timeout=30000)
