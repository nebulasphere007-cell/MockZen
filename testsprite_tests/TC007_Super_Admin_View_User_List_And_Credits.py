...
async def run_test():
    ...
    try:
        ...
        # -> Input super admin credentials and click login button to access dashboard.
        ...
        # -> Verify each user's credit balance is accurate and matches backend data by checking details or refreshing data if possible.
        frame = context.pages[-1]
        # Click 'View Details' for the first user to verify credit balance accuracy
        elem = frame.locator('xpath=html/body/main/div/div[2]/div/div[3]/div/div/table/tbody/tr/td[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click 'Back to Users' to return to the user list and attempt to refresh or verify credit balances for other users.
        frame = context.pages[-1]
        # Click 'Back to Users' button to return to user list
        elem = frame.locator('xpath=html/body/main/div/div[2]/div/div[3]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click 'View Details' for another user to verify credit balance accuracy.
        frame = context.pages[-1]
        # Click 'View Details' for the second user in the list to verify credit balance accuracy
        elem = frame.locator('xpath=html/body/main/div/div[2]/div/div[3]/div/div/table/tbody/tr[2]/td[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click 'Back to Users' button to return to user list and attempt to refresh or verify credit balances for other users.
        frame = context.pages[-1]
        # Click 'Back to Users' button to return to user list
        elem = frame.locator('xpath=html/body/main/div/div[2]/div/div[3]/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Click 'View Details' for the third user in the list to verify credit balance accuracy.
        frame = context.pages[-1]
        # Click 'View Details' for the third user in the list
        elem = frame.locator('xpath=html/body/main/div/div[2]/div/div[3]/div/div/table/tbody/tr[3]/td[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        # -> Scroll down to check if more users are listed beyond the visible ones to verify the completeness of the user list.
