...
async def run_test():
    ...
    try:
        ...
        # -> Select a user with sufficient credits to deduct credits.
        frame = context.pages[-1]
        # Click 'View Details' for the first user to check credits and possibly deduct credits
        elem = frame.locator('xpath=html/body/main/div/div[2]/div/div[3]/div/div/table/tbody/tr/td[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Refresh the page to attempt reloading the current credits for the user.
        frame = context.pages[-1]
        ...
        # -> Select a user with sufficient credits to deduct credits.
        frame = context.pages[-1]
        # Click 'View Details' for the second user to check credits and possibly deduct credits
        ...
        try:
            ...
            raise AssertionError("Test failed: The credit deduction did not reflect accurately and immediately on the dashboard or backend as expected for the super admin user.")
