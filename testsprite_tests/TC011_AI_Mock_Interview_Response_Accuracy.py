...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password and click login button to log in as super admin.
        ...
        # -> Navigate to the AI mock interview session start page or tab.
        frame = context.pages[-1]
        # Click on the 'Users' tab to manage users and find a user to start AI mock interview session
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Interview Success! Outstanding Performance')).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test plan execution failed: The AI mock interview did not respond accurately and consistently to the series of user inputs as expected.")
